 ...
 */
public class TipsActivity extends TabActivity {
        ...
        mListView.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (tip.getUser() != null) {
                    ...
                    Intent intent = new Intent(TipsActivity.this, UserActivity.class);
                    intent.putExtra(UserActivity.EXTRA_USER, tip.getUser().getId());
    ...
    private void initTabHost() {
        ...
        // Maps tab
        /* Because tips have venues that don't have lat/lng in them, it doesn't make sense to show
         * a map. Someday, when we can do backgorund lookups and shit, we will.
        Intent intent = new Intent(this, TipsMapActivity.class);
    ...
    private class SearchTask extends AsyncTask<Void, Void, Group> {
         ...
         *
         */
        private static final int MAX_TIPS = 30;
        ...
        Group search() throws FoursquareException, IOException {
            ...
            if (location == null) {
                if (DEBUG) Log.d(TAG, "Cannot search without location.");
                return null;
            } else {
                // Try to make the search radius to be the same as our
                // accuracy.
                if (DEBUG) Log.d(TAG, "Searching with location: " + location);
                return foursquare.tips(String.valueOf(location.getLatitude()), String
                        .valueOf(location.getLongitude()), MAX_TIPS);
            }
        }
    }
